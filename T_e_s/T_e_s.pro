...
TARGET = T_e_s
DESTDIR = ../x64/Debug
QT += core sql network gui axserver axcontainer widgets location nfc qml bluetooth positioning printsupport sensors quickwidgets quick 3dcore 3danimation 3dextras 3dinput 3dlogic 3drender 3dquick gamepad openglextensions qmltest quickcontrols2 scxml charts datavisualization testlib
